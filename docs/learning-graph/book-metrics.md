...
|---|---------|-------|--------|-------|
| 1 | Concepts | 338 | Required | Concepts from learning graph |
...
| 5 | Chapter Quizzes | 5 / 16 | Recommended | Chapters with a quiz.md (50 questions total) |
| 6 | Chapter References | 0 / 16 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 338 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 104 | Recommended | Questions in faq.md |
| 9 | Words | 122,215 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 37 | 37 | H4 headers starting with '#### Diagram:' |
| Equations | 0 | 0 | LaTeX expressions (inline and display) |
| Total Words | 122,215 | 85,146 | Words in markdown files |
| Links | 204 | 66 | Hyperlinks in markdown format |
| Equivalent Pages | 498 | 350 | Estimated pages (250 words/page + visuals) |
